...
import { containerVariants, floatingAnimation, itemVariants, titleContainerVariants, titleLetterVariants } from "../utils/animation";
...
export function Home() {
  ...
  const AnimatedCounter = ({ value, suffix, label, delay }: AnimatedCounterProps) => {
    ...
    return (
      ...
      >
        <p className="text-4xl md:text-5xl font-bold bg-linear-to-r from-green-950 via-[#D9FF57] to-green-950 bg-clip-text text-transparent dark:from-green-950 dark:via-[#D9FF57] dark:to-green-950">
          {count}{suffix}
        </p>
    ...
    <Section id="home" className="">
      <div className="flex min-h-screen items-start px-2 py-24 sm:px-6">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.p
                ...
                className="mb-2 text-2xl md:text-2xl text-[#8cb601] font-bold dark:text-[#D9FF57]"
              >
                Hello 👋,
              </motion.p>
              ...
              <motion.p
                variants={itemVariants}
                className="text-lg md:text-xl text-cyan-600 font-medium dark:text-[#D9FF57]"
              >
                I'm
              </motion.p>
              ...
              >
                Créer des{' '}
                <motion.span
                  className="text-[#86af00] inline-block dark:text-[#94c102]"
              ...
              >
                ...
                <a
                  ...
                  className="group inline-flex shrink-0 items-center justify-center gap-1.5 rounded-xl border border-cyan-200 bg-cyan-50 px-2 py-2 text-[10px] font-bold text-cyan-700 transition-all duration-300 hover:border-cyan-400 hover:bg-cyan-100 hover:text-cyan-800 sm:gap-3 sm:px-4 sm:py-3 sm:text-sm dark:border-[#D9FF57] dark:bg-cyan-500/10 dark:text-[#D9FF57] dark:hover:border-[#bfe643] dark:hover:bg-cyan-500/20 dark:hover:text-white"
                >
                  <img
                    src={cvPreview}
                    alt="Aperçu du CV"
                    className="h-6 w-6 rounded-full border border-cyan-400/60 object-cover shadow-lg shadow-cyan-500/20 sm:h-10 sm:w-10 dark:border-[#D9FF57]"
                  />
            ...
            >
              ...
              >
                <div className="relative w-full aspect-square rounded-full p-0 flex items-center justify-center bg-linear-to-br from-cyan-100 to-indigo-100 border-2 border-[#D9FF57] overflow-hidden dark:from-cyan/20 dark:to-iris/20 dark:border-cyan/30">
          ...
          >
            <div className="relative bg-white/30 backdrop-blur-sm p-8 md:p-12 shadow-sm ring-1 ring-slate-200 dark:bg-green-950/30 dark:ring-white/10">
              <div className="absolute -top-px left-1/2 -translate-x-1/2 w-1/3 h-px bg-linear-to-r from-transparent via-[#D9FF57] to-transparent dark:via-cyan" />
